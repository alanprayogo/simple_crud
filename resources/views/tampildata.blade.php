...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">Edit Data Pegawai</li>
@endsection
        ...
        <div class="card-body">
          <form action="/updatedata/{{ $data->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="name" id="name" aria-describedby="fullname" value="{{ $data->name }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="phone" class="form-control" id="phone" aria-describedby="Whatsapp" value="0{{ $data->phone }}">
            </div>
